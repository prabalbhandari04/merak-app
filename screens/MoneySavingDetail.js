    ...
    return (
        <View style={styles.screen}>
            ...
            <View style={styles.headerBar}>
                ...
                >
                    <Text style={[styles.cate_text, { color: currentState == "GOAL" ? 'rgb(45,139, 126)' : 'white' }]}> Target</Text>
                ...
                >
                    <Text style={[styles.cate_text, { color: currentState == "RECORD" ? 'rgb(45,139, 126)' : 'white' }]}>Transaction </Text>
