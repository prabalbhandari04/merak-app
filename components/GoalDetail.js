    ...
    return (
        <View style={styles.card}>
            ...
            <View style={{ flexDirection: 'row' }}>
                ...
                <Text style={{ fontSize: FONTSIZE.header2, fontWeight: '500' }}>{props.value} Nrs</Text>
            </View>
...
const GoalDeTail = props => {
    ...
    const [dateDiff, seDateDiff] = useState(getDateDifference(props.item.data.date.toDate()));
